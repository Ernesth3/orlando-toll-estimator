...
const OrlandoTollWizardAvis: React.FC = () => {
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-6">
              <button
                ...
                className={`px-8 py-4 rounded-lg border-2 transition-colors text-lg font-semibold ${
                  answers.homeBase 
            ...
            <div className="space-y-4">
              <label className="flex items-center space-x-4">
                <input
                  ...
                  className="w-5 h-5 text-[#E31837] border-gray-300 rounded focus:ring-[#E31837]"
                />
                <span className="text-lg text-gray-700">Walt Disney World</span>
              </label>
              <label className="flex items-center space-x-4">
                <input
                  type="checkbox"
                  ...
                  className="w-5 h-5 text-[#E31837] border-gray-300 rounded focus:ring-[#E31837]"
                />
                <span className="text-lg text-gray-700">Universal Orlando</span>
              </label>
              <label className="flex items-center space-x-4">
                <input
                  type="checkbox"
                  ...
                  className="w-5 h-5 text-[#E31837] border-gray-300 rounded focus:ring-[#E31837]"
                />
                <span className="text-lg text-gray-700">Kennedy Space Center / Cocoa Beach</span>
              </label>
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-6">
              <button
                ...
                className="w-12 h-12 rounded-full border-2 border-gray-300 hover:border-gray-400 flex items-center justify-center text-xl font-bold"
              >
                -
              </button>
            ...
            <p className="text-base text-gray-600">Range: 0-4 days</p>
          </div>
        ) : null;
      ...
      case 4:
        return answers.universal ? (
          <div className="space-y-6">
            ...
            <p className="text-base text-gray-600">Range: 0-4 visits</p>
          </div>
        ) : null;
      ...
      case 5:
        return answers.ksc ? (
          <div className="space-y-6">
            ...
            <p className="text-base text-gray-600">Range: 0-3 trips</p>
          </div>
        ) : null;
      ...
      case 6:
        return (
          <div className="space-y-6">
            ...
            <p className="text-base text-gray-600">Range: 0-6 trips</p>
          </div>
        );
...
export default OrlandoTollWizardAvis;
